        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form class="form-horizontal" action="/admin/users/courses/add" method="POST" id="userCourseForm" name="userCourseForm">
                        ...
                        <fieldset class="Hor">
                             <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="courseID" id="courseID" placeholder="1" value="${userCourseForm.courseID!""}"/>
                        ...
                        <fieldset class="Hor">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="room" id="room" placeholder="A 101" value="${userCourseForm.room!""}"/>
                                <#list spring.status.errorMessages as error>
                                    <span class="errorRed">${error}</span>
                                </#list>
                            </div>
        ...
        <div class="table-responsive">
            <table class="table" class="table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <form action="/admin/users/courses/delete/${userCourse.userID}/${userCourse.course.courseID}" method="POST">

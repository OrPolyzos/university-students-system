...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" action="/admin/courses/editCourse" method="POST" id="courseForm" name="courseForm">
                    ...
                    <#--bind this field with the registration form fields-->
                        <div class="form-group">
                            ...
                            <label for="title">Title</label>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" placeholder="Java II" value="${courseForm.title!""}">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" min="1" max="8" name="semester" id="semester" placeholder="4" value="${courseForm.semester!""}"/>
                            </div>
                            <#list spring.status.errorMessages as error>
                                <span class="errorRed">${error}</span>
                            </#list>

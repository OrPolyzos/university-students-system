...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" action="/admin/courses/create" method="POST" id="courseForm"
                  name="courseForm">
                <fieldset class="Norm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title" placeholder="Java I"
                               value="${courseForm.title!""}" required/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="semester" name="semester" placeholder="4"
                               value="${courseForm.semester!""}" required/>
                        <#list spring.status.errorMessages as error>
                            <span class="errorRed">${error}</span>
                        </#list>
                    </div>
...
<div class="container-fluid">
    <div class="row">
        ...
        <form class="Search" class="form-horizontal" action="/admin/courses/search" method="GET" id="courseSearchForm"
              name="courseSearchForm">
            <fieldset class="Norm">
                <div class="col-md-6">
                    <label for="email">Title</label>
                    <@spring.bind "courseSearchForm.title"/>
                    <input type="text" class="form-control" name="title" id="title" placeholder="Java II"
                           value="${courseSearchForm.title!""}"/>
                    <#list spring.status.errorMessages as error>
                        <span class="errorRed">${error}</span>
                    </#list>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="submit" class="btn btn-danger"
                                        formaction="/admin/courses/delete/${course.courseID}" formmethod="POST"

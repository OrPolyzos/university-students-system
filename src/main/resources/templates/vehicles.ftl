...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="form-horizontal" action="/admin/vehicles/create" method="POST" id="vehicleForm"
                  name="vehicleForm">
                ...
                <fieldset class="Hor">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control " name="vehicleID" id="vehicleID" placeholder="ABC-1234"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="afm" id="afm" placeholder="123456789"
                               value="${vehicleForm.afm!""}"/>
                        <#list spring.status.errorMessages as error>
                            <span class="errorRed">${error}</span>
                        </#list>
                    </div>
                ...
                <fieldset class="Hor">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="brand" id="brand" placeholder="Ford"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="model" id="model" placeholder="Focus"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" min=1950 max=2017 step=1 name="year" id="year"
                               placeholder="2001" value="${vehicleForm.year!""}"/>
                        <#list spring.status.errorMessages as error>
                            <span class="errorRed">${error}</span>
                        </#list>
                    </div>
                ...
                <fieldset class="Hor">
                    ...
                    <div class="form-group">
                        ...
                        <input type="String" class="form-control" name="color" id="color" placeholder="Red"
...
<div class="container-fluid">
    <div class="row">
        ...
        <form class="Search" class="form-horizontal" action="/admin/vehicles/search" method="GET" id="vehicleSearchForm"
            ...
            <fieldset class="Norm">
                ...
                <div class="col-md-4">
                    ...
                    <label for="vehicleID">Plate Number</label>
                    <input type="text" class="form-control" name="vehicleID" id="vehicleID" placeholder="ABC-1234"
                           value="${vehicleSearchForm.vehicleID!""}"/>
                    <#list spring.status.errorMessages as error>
                        <span class="errorRed">${error}</span>
                    </#list>
                </div>
            ...
            <#list vehicleList as vehicle>
                <span>
                    ...
                    <form action="/admin/vehicles/edit/${vehicle.vehicleID}" method="GET">
                        ...
                        <td>
                            <button type="submit" formaction="/admin/vehicles/delete/${vehicle.vehicleID}"
                                    formmethod="POST" class="btn btn-danger" onclick="return confirm('Are you sure?')">
